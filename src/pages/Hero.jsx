    ...
    <div onMouseMove={handleMouseMove}
      ...
      <div ref={hero} className='h-screen w-full relative '>
        ...
        <div className='h-[40vh] mt-15 lg:mt-0 md:h-auto flex flex-col justify-center'>
          ...
          <div className='hero-text flex justify-between lg:mt-[53vh] xl:mt-[48vh] mb-5 lg:mb-0 px-5 lg:px-11 font-medium lg:font-bold'>
            <h3>A</h3>
            <h3>SERIOUSLY</h3>
            <h3>GOOD</h3>
          </div>
          ...
          <div className='hero-text  md:absolute h-[30vh] w-full flex-col flex lg:flex lg:flex-row pt-20 lg:mt-25 justify-center items-center text-[16vw] sm:text-[15vw] md:text-[20vw] leading-[9vh] sm:leading-[17vh] md:leading-[28vh] lg:text-[11.8vw] font-bold lg:tracking-tighter md:top-[50%]'>
            <h1>DESIGN</h1>
            <h1>ENGINEER</h1>
          </div>
        </div>
