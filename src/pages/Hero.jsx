    ...
    <div onMouseMove={handleMouseMove}
      ...
      <div ref={hero} className='h-screen w-full relative '>
        ...
        <div className='h-[40vh] mt-15 lg:mt-0 md:h-auto flex flex-col justify-center'>
          ...
          <div className='hero-text flex justify-between md:mt-[10vh] lg:mt-[27vw] px-5 lg:px-11 font-bold lg:font-bold'>
            <h3>A</h3>
            <h3>SERIOUSLY</h3>
            <h3>GOOD</h3>
          </div>
          <div className='flex justify-center md:hidden '>
            <video ref={smvideo} className='h-[35vh] w-[95vw] md:h-[30vh] md:w-[30vw] md:absolute md:z-10 rounded-xl object-cover'
              loop muted autoPlay src="https://www.itsjay.us/videos/jazmin-wong-preview-compressed.mp4"></video>
          </div>
          
          <div className='hero-text  md:absolute h-[30vh] w-full flex-col flex lg:flex lg:flex-row pt-20 lg:mt-15 justify-center items-center text-[16vw] sm:text-[15vw] md:text-[20vw] leading-[13vw] sm:leading-[14vw] md:leading-[16vw] lg:text-[11.8vw] font-bold lg:tracking-tighter md:top-[50%]'>
            <h1>DESIGN</h1>
            <h1>ENGINEER</h1>
          </div>
        </div>
      ...
      <div className='hidden h-screen w-full  md:flex justify-center items-center  '>
        <video ref={video} className='video md:h-[95vh] w-[96vw] rounded'
          loop muted autoPlay src="https://www.itsjay.us/videos/jazmin-wong-preview-compressed.mp4"></video>
      </div>
    </div>
  )
