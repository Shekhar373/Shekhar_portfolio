...
const About = () => {
  ...
  return (
    <div id='about' className='  relative h-[330vh]  w-full flex justify-center'>
      <div id='about-text' className='about-text-parent h-screen w-full flex lg:mt-[20vh]'>
        <div className='about-text h-full w-[60%] p-10 text-[2.5vw] font-medium flex justify-center items-center'>
        ...
        <div className='h-full about-video w-[40%] flex justify-center items-center'>
             <video ref={aboutvideo} loop muted autoPlay
             className=' h-[30vh] w-[30vw] rounded-xl  object-cover'
